...
namespace TadaWy.Infrastructure.Migrations
{
    ...
    [Migration("20260622161027_improvePerformanceIndex")]
    partial class improvePerformanceIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.AiBrainScan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.PatientChronicDisease", b =>
                {
                    b.Property<int>("PatientId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasIndex("Status", "IsReleasedToWallet");

                    b.HasIndex("DoctorId", "Method", "Status");
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.UserSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("TadaWy.Domain.Entities.Identity.ApplicationUser", "Patient")
                        .WithMany()
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TadaWy.Domain.Entities.Patient", null)
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.City", b =>
                {
                    b.HasOne("TadaWy.Domain.Entities.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.Notification", b =>
                {
                    ...
                    b.HasOne("TadaWy.Domain.Entities.Identity.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.PatientAllergy", b =>
                {
                    b.HasOne("TadaWy.Domain.Entities.Allergy", "Allergy")
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.PatientChronicDisease", b =>
                {
                    b.HasOne("TadaWy.Domain.Entities.ChronicDisease", "ChronicDisease")
            ...
            modelBuilder.Entity("TadaWy.Domain.Entities.UserSettings", b =>
                {
                    b.HasOne("TadaWy.Domain.Entities.Identity.ApplicationUser", "User")
                        .WithOne("Settings")
                        .HasForeignKey("TadaWy.Domain.Entities.UserSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
