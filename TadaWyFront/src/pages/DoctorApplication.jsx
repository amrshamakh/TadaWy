...
const DoctorApplication = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-white from-1%
via-teal-200
...
dark:to-[#202326] flex items-center justify-center p-4 py-8">
      <div className="bg-white dark:bg-[#1E293B] rounded-2xl shadow-xl w-full max-w-md p-8 border border-gray-200 dark:border-[#334155]">
        ...
        <p className="text-center text-gray-500 dark:text-gray-400 mb-6">
          {t('auth.doctor.subtitle', 'Enter your details to get start as a Doctor with TadaWy')}
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder={t('auth.doctor.createPassword', 'Create a password')}
                className="w-full px-4 py-2.5 bg-gray-50 dark:bg-[#334155] border border-gray-200 dark:border-[#475569] text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition"
                required
              />
            </div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              {t('auth.doctor.confirmPassword', 'Confirm Password')}
            </label>
            <div className="relative">
              <input
                type="password"
                ...
                placeholder={t('auth.doctor.confirmPasswordPlaceholder', 'Confirm your password')}
                className="w-full px-4 py-2.5 bg-gray-50 dark:bg-[#334155] border border-gray-200 dark:border-[#475569] text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition"
                required
              />
            </div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              {t('auth.doctor.addressDetails', 'Address Details')}
            </label>
            <textarea
              ...
              rows="2"
              className="w-full px-4 py-2.5 bg-gray-50 dark:bg-[#334155] border border-gray-200 dark:border-[#475569] text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition resize-none"
            />
          </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div>
              ...
              <label className="flex flex-col items-center justify-center h-24 border border-gray-300 dark:border-[#475569] rounded-xl cursor-pointer hover:border-teal-500 bg-gray-50 dark:bg-[#334155]/50 transition">
                {formData.cv ? (
                  <FileText className="w-6 h-6 text-teal-500 dark:text-teal-400 mb-1" />
                ) : (
                  <Upload className="w-6 h-6 text-gray-400 mb-1" />
                )}

                <span className="text-xs text-gray-500 dark:text-gray-400">
                  {formData.cv ? formData.cv.name : t('auth.doctor.uploadFile', 'Upload your File')}
                </span>
                <input
                  type="file"
                  accept=".pdf,.doc,.docx"
        ...
        <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-[#334155] rounded-xl w-full max-w-3xl p-4 space-y-3">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white">
              {t('auth.doctor.selectLocationTitle', 'Select Your Location')}
            </h3>
