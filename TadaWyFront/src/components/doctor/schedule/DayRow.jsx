  ...
  return (
    <div className="flex items-start gap-4 py-4 border-b border-gray-50 last:border-b-0">
      ...
      <div className="flex items-center gap-3 w-28 flex-shrink-0 pt-1">
        ...
        <div>
          <p className="text-sm font-semibold text-gray-700 leading-tight">{name}</p>
          {enabled && (
      ...
      <div className="flex-1">
        {!enabled ? (
          <p className="text-gray-300 text-sm italic pt-1">Day Off</p>
        ) : (
              ...
              <div key={idx} className="flex items-center gap-2 flex-wrap">
                ...
                {idx > 0 && (
                  <button
                    ...
                    className="w-6 h-6 flex items-center justify-center rounded-full text-red-400 hover:bg-red-50 hover:text-red-500 transition text-lg leading-none"
                    title="Remove slot"
                  >
                    ×
                  </button>
