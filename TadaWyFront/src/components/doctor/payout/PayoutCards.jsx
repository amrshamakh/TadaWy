...
export default function PayoutCards() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-700/50 flex flex-col justify-between transition-all hover:shadow-md">
        <div className="flex justify-between items-start mb-6">
          ...
          <span className="px-2.5 py-1 text-xs font-semibold text-teal-600 bg-teal-50 dark:bg-teal-500/10 dark:text-teal-400 rounded-lg">
            {t("doctorDashboard.payout.cards.vsLastMonth", "+12% vs last month")}
          </span>
        </div>
        <div>
          ...
          <div className="flex items-baseline gap-1.5">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">15,400</h2>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-700/50 flex flex-col justify-between transition-all hover:shadow-md">
        ...
        <div>
          ...
          <div className="flex items-baseline gap-1.5">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">14,000</h2>
            <span className="text-sm font-semibold text-slate-500 dark:text-slate-400">{t("booking.sidebar.currency", "L.E.")}</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-700/50 flex flex-col justify-between transition-all hover:shadow-md">
        ...
        <div>
          ...
          <div className="flex items-baseline gap-1.5">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">8,200</h2>
            <span className="text-sm font-semibold text-slate-500 dark:text-slate-400">{t("booking.sidebar.currency", "L.E.")}</span>
          </div>
        </div>
      </div>
